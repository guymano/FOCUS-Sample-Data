...
---
    ...
    python generators/generate_aws_focus_1_3.py \
        --rows 1000 --seed 1302 \
        --out FOCUS-1.3/focus_sample_costandusage_aws_1000.csv
    # Contract Commitment (derived from the same commitments)
    python generators/generate_aws_focus_1_3.py --dataset contract_commitment \
        --out FOCUS-1.3/focus_sample_contractcommitment_aws.csv
"""
...
DEFAULT_ROWS = 1000
DEFAULT_SEED = 1302
DEFAULT_OUT = Path("FOCUS-1.3/focus_sample_costandusage_aws_1000.csv")
DEFAULT_COMMITMENT_OUT = Path("FOCUS-1.3/focus_sample_contractcommitment_aws.csv")
PROVIDER_NAME = "AWS"
PUBLISHER_NAME = "AWS"
