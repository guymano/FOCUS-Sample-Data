...
CLI
---
    python generators/generate_gcp_focus_1_2.py \
        --rows 1000 --seed 1202 \
        --out FOCUS-1.2/focus_sample_costandusage_gcp_1000.csv
"""
...
def _commitment_group(
    ...
    commit_type = "Committed Use Discount"
    ...
    commit_resource_name = f"cud-{_hexid(rng, 10)}"
    commit_sku_id = _sku(rng)
    commit_sku_price_id = _sku(rng)
