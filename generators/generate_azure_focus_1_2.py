...
CLI
---
    python generators/generate_azure_focus_1_2.py \
        --rows 1000 --seed 1202 \
        --out FOCUS-1.2/focus_sample_costandusage_azure_1000.csv
"""
...
DEFAULT_ROWS = 1000
DEFAULT_SEED = 1202
DEFAULT_OUT = Path("FOCUS-1.2/focus_sample_costandusage_azure_1000.csv")
...
def _commitment_group(
    ...
    fleet_id = f"urn:focus-sample:azure:{region_id}:{ctx['sub_id']}:compute-fleet:{fleet_name}"
