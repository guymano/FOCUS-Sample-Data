...
CLI
---
    python generators/generate_azure_focus_1_3.py \
        --rows 1000 --seed 1302 \
        --out FOCUS-1.3/focus_sample_costandusage_azure_1000.csv
    python generators/generate_azure_focus_1_3.py --dataset contract_commitment \
        --out FOCUS-1.3/focus_sample_contractcommitment_azure.csv
"""
